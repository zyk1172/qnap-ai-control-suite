...
export function createServer() {
  ...
  registerControlTools(server); registerSystemTools(server); registerFileTools(server); registerDockerTools(server); registerQNAPTools(server); registerJobTools(server);
  return server;
}
